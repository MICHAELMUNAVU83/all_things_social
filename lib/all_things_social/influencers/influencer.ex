defmodule AllThingsSocial.Influencers.Influencer do
  use Ecto.Schema
  ...
  @doc """
  A influencer changeset for registration.
  ...
  @doc """
  A influencer changeset for changing the email.

  It requires the email to change otherwise an error is added.
  """
  def email_changeset(influencer, attrs) do
    influencer
    |> cast(attrs, [:email])
    |> validate_email()
    |> case do
  ...
  @doc """
  A influencer changeset for changing the password.
  ...
  ## Options
    ...
    * `:hash_password` - Hashes the password so it can be stored securely
      ...
      Defaults to `true`.
  """
  def password_changeset(influencer, attrs, opts \\ []) do
    influencer
    |> cast(attrs, [:password])
  ...
  """
  def confirm_changeset(influencer) do
    now = NaiveDateTime.utc_now() |> NaiveDateTime.truncate(:second)
    change(influencer, confirmed_at: now)
  end
