defmodule AllThingsSocial.InfluencerAccountsTest do
  ...
  describe "influencer_accounts" do
    ...
    test "get_influencer_account!/1 returns the influencer_account with given id" do
      ...
      assert InfluencerAccounts.get_influencer_account!(influencer_account.id) ==
               influencer_account
    end
    ...
    test "create_influencer_account/1 with valid data creates a influencer_account" do
      ...
      assert {:ok, %InfluencerAccount{} = influencer_account} =
               InfluencerAccounts.create_influencer_account(valid_attrs)
    ...
    test "create_influencer_account/1 with invalid data returns error changeset" do
      assert {:error, %Ecto.Changeset{}} =
               InfluencerAccounts.create_influencer_account(@invalid_attrs)
    end
    ...
    test "update_influencer_account/2 with valid data updates the influencer_account" do
      ...
      assert {:ok, %InfluencerAccount{} = influencer_account} =
               InfluencerAccounts.update_influencer_account(influencer_account, update_attrs)
    ...
    test "update_influencer_account/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               InfluencerAccounts.update_influencer_account(influencer_account, @invalid_attrs)

      assert influencer_account ==
               InfluencerAccounts.get_influencer_account!(influencer_account.id)
    end

    test "delete_influencer_account/1 deletes the influencer_account" do
      influencer_account = influencer_account_fixture()

      assert {:ok, %InfluencerAccount{}} =
               InfluencerAccounts.delete_influencer_account(influencer_account)
